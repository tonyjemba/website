            ...
            <div class=" w-11/12 mx-auto flex mt-22 ">
              <div class="w-full lg:w-2/4 text-lg space-y-8 lg:space-y-10">
                ...
                >
                  ...
                  <div ref="icons" class="flex justify-center gap-x-5 items-center">
                    <div>
                    ...
                    <div>
                      <NuxtLink
                        target="_blank" to="https://www.linkedin.com/in/tonyjemba/" aria-label="LinkedIn"
                        rel="noopener"
                      >
                    ...
                    <div>
                      <NuxtLink
                        target="_blank" to="https://www.youtube.com/@tonyjemba" aria-label="Youtube"
                        rel="noopener"
                      >
              ...
              <div
                v-show="lgAndLarger" class=" relative target6 w-2/4 flex justify-center items-center "
                :class="`${showElement ? 'visible' : 'hidden'}`"
              >
                <div>
                  <div ref="vuelogo" class=" absolute  flex flex-row  justify-between items-end h-64 w-44 z-10 ml-16">
                  ...
                  <div ref="vuelogo" class=" absolute  flex justify-center items-center h-40 w-10 z-10 ">
                    ...
                    <IconLaravel v-else class="animate-bounce-slow fade-in cursor-pointer" />
                  </div>

                  <div>
                    <svg
                      id="visual" viewBox="0 0 900 900" width="350" height="340" xmlns="http://www.w3.org/2000/svg"
                      xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                    >

                      <g transform="translate(395.3409694537647 549.129049274956)">
                        <path
                          ref="blobl" class="opacity-10"
                      ...
                      <g class="cursor-pointer" transform="translate(486.5623892955482 539.9985897735369)">
                        <path
                          ref="blob2" class="invisible opacity-10"
